...
public class UserController {
    ...
    @ApiOperation("登陆")
    @PostMapping("login")
    public ServerResponse login(@ApiParam(value = "用户登陆姓名",required = true) @NotBlank(message = "用户名不能为空") String username,
                                @ApiParam(value = "用户登录密码",required = true) @NotBlank(message = "密码不能为空") String password){
    ...
    public ServerResponse register(@ApiParam("注册用户详细信息") @Valid UserRegisterDto user){
